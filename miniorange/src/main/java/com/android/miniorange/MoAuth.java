...
public class MoAuth {
    ...
    public void startAuthorizationWithPKCE() {
        ...
        if (clientId == null || baseUrl == null || redirectUri == null) {
            ...
            if(loginSuccessListener != null){loginSuccessListener.onError("SSO configuration is incomplete.!");}
            return;
        }
            ...
            if(savedState!=null && savedState.equals(receivedState)){
                ...
                if("Implicit".equals(grantType)){ //handling implicit grant
                    ...
                    try {
                        ...
                        if (JwtUtils.verifySignature(idToken, publicKey) && idToken!= null) {
                            ...
                            if(loginSuccessListener != null){loginSuccessListener.onError("Invalid token signature found.");}
                        }
                    } catch (Exception e) {
                        Log.e("mo","Exception occurred.. :"+e);
                        throw new RuntimeException(e);
                    }
                ...
                if(loginSuccessListener != null){loginSuccessListener.onError("Invalid State Received or State Mismatch!");}
            }
        } else{
            Log.e("mo", "URI is null. Authorization code not received.");
            if (loginSuccessListener != null) {loginSuccessListener.onError("Redirect URI is null.");}
        }
    ...
    private void requestForToken(String code, @Nullable String codeVerifier) {
        ...
        //making post request at token endpoint ...
